export const paymentsUseCase = {
  ...
  industries: [
    {
      title: "Fintech Apps",
      img: "https://plus.unsplash.com/premium_photo-1664478157873-50d4963c1d11?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8ZmludGVjaHxlbnwwfHwwfHx8MA%3D%3D",
    },
    {
      title: "Crypto Gateways",
      img: "https://plus.unsplash.com/premium_photo-1670249419932-a7027d9003f8?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8Q3J5cHRvfGVufDB8fDB8fHww",
    },
    {
      title: "BNPL Platforms",
      img: "https://media.istockphoto.com/id/1483523977/photo/bnpl-buy-now-pay-later-shopping-online-icon-online-banking-businessman-using-smartphone.webp?a=1&b=1&s=612x612&w=0&k=20&c=yH4NfzvDxqOSzqxs8UBHjam1FysWE9M313evzTxwUBs=",
    },
    {
      title: "E-commerce Checkouts",
      img: "https://media.istockphoto.com/id/865087924/photo/online-shopping-concept-nackground-mobile-phone-or-smartphone-with-cart-and-boxes-and-bag.webp?a=1&b=1&s=612x612&w=0&k=20&c=fTtvfAV3pEqPTfuvDqh9ujU1t5kCtur-FjwlwH0Kpmk=",
    },
    {
      title: "Wallet Apps",
      img: "https://images.unsplash.com/photo-1609851451108-e937620f1210?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8V2FsbGV0JTIwQXBwc3xlbnwwfHwwfHx8MA%3D%3D",
    },
    {
      title: "P2P Money Transfers",
      img: "https://plus.unsplash.com/premium_photo-1739995619729-0426f345e980?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8UDJQJTIwTW9uZXklMjBUcmFuc2ZlcnN8ZW58MHx8MHx8fDA%3D",
    },
  ],

  featuresTitle: "Empowering Your Payment Experiences",
  features: [
    {
    ...
    },
    {
      ...
      text: "Prevent friendly fraud, stolen card usage, and repeat chargeback abusers by verifying the user’s identity and intent before the payment is approved. Reduce losses and increase merchant confidence.",
    },
    {
  ...
  tableData: [
    ...
    { name: "TransactX", tvl: 489.32, holders: 958 },
    { name: "GlobalRemit", tvl: 302.88, holders: 1760 },
    { name: "CoinCheckOut", tvl: 199.54, holders: 1123 },
    { name: "StablePort", tvl: 154.27, holders: 680 },
    { name: "FlowPay", tvl: 121.96, holders: 147 },
    { name: "ZapTransfer", tvl: 97.61, holders: 1267 },
    { name: "OpenWallet", tvl: 74.82, holders: 329 },
    { name: "BorderlessPay", tvl: 51.37, holders: 89 },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Core identity checks run off-chain for speed and privacy, while verification proofs or risk signals can be anchored on-chain when needed.",
    },
    {
