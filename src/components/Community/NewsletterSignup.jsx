    ...
    <section className="relative py-32 overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-10 left-10 w-96 h-96 opacity-20">
          <div className="floating-shape rotate-12 bg-gradient-to-br from-purple-600 to-blue-600 rounded-3xl blur-3xl"></div>
        </div>
        <div className="absolute top-32 right-20 w-80 h-80 opacity-30">
          <div className="floating-shape -rotate-45 bg-gradient-to-tr from-indigo-600 to-purple-700 rounded-full blur-2xl"></div>
        </div>
        <div className="absolute bottom-20 left-32 w-72 h-72 opacity-25">
          <div className="floating-shape rotate-90 bg-gradient-to-bl from-purple-500 to-pink-600 rounded-3xl blur-3xl"></div>
        </div>
        <div className="absolute -bottom-10 right-10 w-96 h-96 opacity-15">
          <div className="floating-shape rotate-45 bg-gradient-to-t from-blue-600 to-purple-800 rounded-full blur-3xl"></div>
        </div>
      </div>

      {/* Main Content Card */}
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        <div className="backdrop-blur-xl bg-white/5 border rounded-2xl p-12 md:p-16 text-center border border-gray-200">
          {/* Small Upper Text */}
          <p className="text-indigo-600 font-medium tracking-widest text-sm uppercase mb-3">
            Stay up to date
          </p>
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto items-center justify-center">
            <div className="relative w-full sm:w-auto flex-1">
              <input
                ...
                className="w-full px-8 py-5 bg-white/10 border border-gray-500 rounded-full text-black placeholder-gray-500 
                         focus:outline-none focus:border-indigo-600 focus:bg-white/15 transition-all duration-300
                         text-md backdrop-blur-md"
              />
            </div>
