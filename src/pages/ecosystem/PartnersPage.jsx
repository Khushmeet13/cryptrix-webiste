...
const partners = [
  {
    ...
    category: "DeFi",
    desc: "Lending & borrowing protocol powered by SPH",
  },
  {
    name: "SunSwap",
    logo: "https://fleet.ie/wp-content/uploads/2021/10/Sunswap-logo-1-300x169.jpeg",
    category: "DeFi",
    desc: "Decentralized exchange integrated with SPH",
  },
  {
    name: "Bybit",
    logo: "https://fh-static.bycsi.com/images/home/official-image.png",
    category: "Exchanges",
    desc: "Global exchange supporting SPH assets",
  },
  {
    name: "Trust Wallet",
    ...
    category: "Wallets",
    desc: "Secure wallet with SPH integration",
  },
];
...
const testimonials = [
  {
    quote:
      "SPH infrastructure allowed us to scale our protocol with confidence and speed.",
    name: "Alex Morgan",
    role: "Core Developer, JustLend",
  },
  {
    quote:
      "The validator and node ecosystem around SPH is one of the most reliable we’ve seen.",
    name: "Sarah Kim",
    ...
    <div className="bg-black text-white">
      ...
      <section className="py-16 px-6 bg-gray-50 text-black">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl mb-6">How Partners Integrate with SPH</h2>

          <div className="grid md:grid-cols-4 gap-6">
            {["Partner App", "SPH APIs", "Validators", "Users"].map((step, i) => (
              <div
                key={i}
      ...
      <section className=" text-center px-6 bg-white text-black">
        ...
        <p className="text-gray-400 mb-10">
          Build, integrate, and grow with the SPH ecosystem.
        </p>
